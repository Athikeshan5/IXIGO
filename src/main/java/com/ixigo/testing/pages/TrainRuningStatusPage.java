...
public class TrainRuningStatusPage {
    ...
    public void clickcheck(WebDriver driver) {
        allUtilityFunctions.waitForClickable(driver, check, 20);
        getCheck().click();
    }

    public void searchtrainfield(WebDriver driver) {
        allUtilityFunctions.waitForVisibility(driver, page, 20);
        allUtilityFunctions.waitForClickable(driver, searchTrain, 20);
    ...
    public void entertrainname(WebDriver driver, String s) throws InterruptedException {
        ...
        allUtilityFunctions.waitForVisibility(driver, getdropdown(), 30);
