...
public class seatAvailabilityTest {
    ...
    @When("click the filter for booking {string}")
    public void click_the_filter_for_booking(String string) {
       
        Pages.saf.get().bookticket(b.getDriver(), string);
    }
    ...
    public void verify_the_payment_page() {
        ...
        sa.assertTrue(val.contains(
            allUtilityFunctions.getExcelData("./src/test/resources/Reader/testData.xlsx", "Sheet1", 2, 4)
        ));
